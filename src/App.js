            ...
            <div className="container">
                ...
                <div className="row me-row content-ct">
                    ...
                    <div className="col-md-4 feature">
                        ...
                        <p>
                            Super cool discounts if you purchase early bird
                            tickets now. Limited tickets available with some
                            awesome perks and goodies!
                        </p>
                    </div>
                    <div className="col-md-4 feature">
                        ...
                        <p>
                            Best in class expert speakers who have extensive
                            knowledge of the topic. All speakers are curated by
                    ...
                    <div className="col-md-4 feature">
                        ...
                        <p>
                            Meet the people attending this event around the
                            globe. This will be the best opportunity to meet and
                            greet people from your industry.
                        </p>
                    </div>
                </div>
                {/* <!-- End: Desc --> */}
                ...
                <div className="row me-row content-ct speaker" id="speakers">
                    ...
                    <div className="col-md-4 col-sm-6 feature">
                        ...
                        <p>
                            Stephie is a user experience researcher and
                            designer. In over 15 years of working on the web,
                            she has worn many hats, including a product lead for
                            a tech startup in publishing...
                        </p>
                        <ul className="speaker-social">
                            <li>
                                <a href="#">
                    ...
                    <div className="col-md-4 col-sm-6 feature">
                        ...
                        <h3>Harry Roberts</h3>
                        <p>
                            Harry is a freelance designer, developer, writer,
                            speaker and front-end architect from the UK,
                            previously working as Senior UI Developer for Sky.
                            He Tweets at...
                        </p>
                        <ul className="speaker-social">
                            <li>
                                    ...
                                    <div className="col-md-6">
                                        <div className="media">
                                            ...
                                            <div className="media-body">
                                                ...
                                                <p>
                                                    Simon is designer and
                                                    partner at Fictivekin and
                                                    has worked in a variety of
                                                    situations for bands, record
                                                    labels, governments, polar
                                                    explorers, and most other
                                                    things.{" "}
                                                </p>
                                            </div>
                                        </div>
            ...
            <div className="container-fluid footer">
                <div className="row contact">
                    ...
                    <div className="col-md-4 col-md-offset-1 content-ct">
                        ...
                        <p>
                            Lorem <a href="#">#Ipsum</a> is a dummy text used as
                            a text filler in designs. This is just a dummy text.
                            via <a href="#">@designerdada</a>{" "}
                        </p>
                        <hr />
                        <p>
                            Lorem Ipsum is a <a href="#">#dummy</a> text used as
                            a text filler in designs. This is just a dummy text.
                            via <a href="#">@designerdada</a>{" "}
                        </p>
                        <hr />
                ...
                <div className="row footer-credit">
                    <div className="col-md-6 col-sm-6">
                        <p>
                            &copy; 2015,{" "}
                            <a href="http://www.designerdada.com">
                                DesignerDada.com
                            </a>{" "}
                            | All rights reserved.
                        </p>
