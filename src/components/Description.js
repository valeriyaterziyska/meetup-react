        ...
        <div className="container">
            ...
            <div className="row me-row content-ct">
                ...
                <div className="col-md-4 feature">
                    ...
                    <p>
                        Super cool discounts if you purchase early bird tickets
                        now. Limited tickets available with some awesome perks
                        and goodies!
                    </p>
                </div>
                <div className="col-md-4 feature">
                    ...
                    <p>
                        ...
                        knowledge of the topic. All speakers are curated by the
                        panel of experts.
                    </p>
                </div>
                <div className="col-md-4 feature">
                    ...
                    <p>
                        Meet the people attending this event around the globe.
                        This will be the best opportunity to meet and greet
            ...
            <div className="row me-row content-ct speaker" id="speakers">
                ...
                <div className="col-md-4 col-sm-6 feature">
                    ...
                    <p>
                        Stephie is a user experience researcher and designer. In
                        over 15 years of working on the web, she has worn many
                        hats, including a product lead for a tech startup in
                        publishing...
                    </p>
                    <ul className="speaker-social">
                        <li>
                ...
                <div className="col-md-4 col-sm-6 feature">
                    ...
                    <p>
                        ...
                        speaker and front-end architect from the UK, previously
                        working as Senior UI Developer for Sky. He Tweets at...
                    </p>
                    <ul className="speaker-social">
                        <li>
                            <a href="#">
